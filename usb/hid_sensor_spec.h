...
#define HID_USAGE_SENSOR_EVENT_HIGH_THESHOLD_CROSS_ABOVE \
...
#define HID_USAGE_SENSOR_EVENT_HIGH_THRESHOLD_CROSS_BELOW \
...
#define HID_USAGE_SENSOR_EVENT_LOW_THRESHOLD_CROSS_ABOVE \
...
#define HID_USAGE_SENSOR_EVENT_LOW_THRESHOLD_CROSS_BELOW \
...
#define HID_USAGE_SENSOR_EVENT_ZERO_THRESHOLD_CROSS_ABOVE \
...
#define HID_USAGE_SENSOR_EVENT_ZERO_THRESHOLD_CROSS_BELOW \
...
#define HID_USAGE_REPORTING_STATE_ON_THRESHOLD \
...
#define HID_SENSOR_VALUE_SIZE_32(x) \
    (uint8_t)((x) >> 0), (uint8_t)((x) >> 8), (uint8_t)((x) >> 16), (uint8_t)((x) >> 24)
